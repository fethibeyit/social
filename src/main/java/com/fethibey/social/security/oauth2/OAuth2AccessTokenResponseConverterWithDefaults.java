 ...
 * @author Joe Grandja
 */
public class OAuth2AccessTokenResponseConverterWithDefaults implements Converter{
	...
	@Override
	public OAuth2AccessTokenResponse convert(Object tokenParameters) {

		var tokenResponseParameters = (Map<String, Object>) tokenParameters;
		...
		if (OAuth2AccessToken.TokenType.BEARER.getValue().equalsIgnoreCase(String.valueOf(tokenResponseParameters.get(OAuth2ParameterNames.TOKEN_TYPE)))) {
